      ...
      <div id="container">
        <div id="center" class="column">
          <div id="content">
            ...
            $sql = "SELECT * FROM tb_horas_exercicio Where user_id='$user_id' ";
            $result = mysqli_query($conn, $sql);
            ...
            if (mysqli_num_rows($result) > 0) {
              ...
              while($row = mysqli_fetch_assoc($result)) {
                $min=$row['nr_horas'];
                $data=$row['dataResg'];
                if(strtolower(date('F',strtotime($data))) == strtolower(date('F'))){
      $soma+=$min;
      echo   "<tr>";
      echo "<td bgcolor=\"#F8F7F1\"><strong>".$data."</strong></td>";
      echo "<td bgcolor=\"#F8F7F1\"><strong>".$min."</td>";
      echo "<td rowspan='2' bgcolor=\"#F8F7F1\"><strong>".$soma."</td>";
      echo "<td rowspan='2' bgcolor=\"#F8F7F1\"><strong>".$soma."</td>";
      echo   "</tr>";
  }else{
    $soma=0;
