...
if ( $erro ) {
    echo "<script>alert('$comment_id Envie um email válido!');top.location.href='ver_topico.php?id=" . $id . "';</script>";
var_dump($comment_id);
var_dump($id);
...
// verifica se foi enviado um arquivo
    ...
    $sql2 = "INSERT INTO forum_answer (question_id, id_login, a_answer,a_imagem, data_reg)
             VALUES('$subcategoria_id', '$user_id', '$a_answer', '$destino','$datetime')";
